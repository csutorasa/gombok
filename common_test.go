...
func createTestTypeProcessorData(packageName string, structName string, fields map[string]string, fieldComments map[string][]string, fieldNames []string, typeComments []string, genericTypes map[string]string, genericTypeNames []string) *testTypeProcessorData {
...
func (d *testTypeProcessorData) addGenericType(name string, typeName string) *testTypeProcessorData {
	d.typeProcessorData.genericTypes[name] = typeName
	d.typeProcessorData.genericTypeNames = append(d.typeProcessorData.genericTypeNames, name)
	return d
}
